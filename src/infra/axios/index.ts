    ...
    async getByCCA2(cca2: string): Promise<ICountry> {
        ...
        try {
            ...
            const country: ICountry = {
                ...
                latitude: countriesRestApi.capitalInfo.latlng[0] ?? 0,
                longitude: countriesRestApi.capitalInfo.latlng[1] ?? 0,
                ...
                population: countriesRestApi.population ?? 0,
            ...
            throw new CCANotFoundError(cca2)
        }
    }
}